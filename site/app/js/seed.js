...
export async function seedIfEmpty() {
  ...
  const client = await put("profiles", {
    ...
    timezone: "UTC",
    notes: "Managed on their behalf. They connect their own accounts — we never hold their password.",
  });

  await putMany("accounts", [
    { id: uid("acc"), profileId: personal.id, platform: "x", handle: "yourhandle", displayName: "You", status: "disconnected" },
    { id: uid("acc"), profileId: personal.id, platform: "bluesky", handle: "you.bsky.social", displayName: "You", status: "disconnected" },
    ...
    { id: uid("acc"), profileId: business.id, platform: "linkedin", handle: "rullo-enterprises", displayName: "Rullo Enterprises", status: "disconnected" },
